...
pass_analysis_site_bp = Blueprint('pass_analysis_site_bp', __name__)
...
@pass_analysis_site_bp.route('/passAnalysis', methods=['GET'])
def pass_analysis_page():
    return render_template('pass_analysis.html')

@pass_analysis_site_bp.route('/api/passAnalysis/<stationOpID>/<tagOpID>/<date_from>/<date_to>', methods=['GET'])
