...
toll_station_passes_cli_bp = Blueprint('toll_station_passes_cli', __name__)
...
@toll_station_passes_cli_bp.route('/tollStationPasses/<string:tollStationID>/<string:date_from>/<string:date_to>', methods=['GET'])
def toll_station_passes_cli(tollStationID, date_from, date_to):
    try:
        ...
        # Construct the passList in order
        pass_list = []
        ...
        # Use json.dumps with OrderedDict to preserve order
        return Response(
